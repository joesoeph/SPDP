	...
	<table style="border-collapse: collapse; width: 100%;" border="1">
		<tbody>
			<tr>
				...
				<td style="width: 15%; text-align: center;">Form A-04</td>
			</tr>
		</tbody>
	</table>
	<table style="border-collapse: collapse; width: 100%; height: 57px; margin-bottom: 20px;" border="0">
		<tbody>
			<tr style="height: 19px;">
				...
				<td style="width: 20.8236%; height: 19px; vertical-align: bottom;">: <?= $DataDetail->RefundNo ?></td>
			</tr>
			<tr style="height: 19px;">
				<td style="width: 61.3055%; height: 38px;" colspan="2" rowspan="2">&nbsp;</td>
				<td style="width: 13.9366%; height: 19px;">TANGGAL</td>
				<td style="width: 20.8236%; height: 19px;">: <?= $DataDetail->RefundDate ?></td>
			</tr>
			<tr style="height: 19px;">
	...
	<table style="border-collapse: collapse; width: 100%; height: 70px; margin-bottom: 10px;" border="1">
		<tbody>
			<tr style="height: 13px; border: 0;">
				<td style="width: 96.0656%; height: 13px;" colspan="5"><strong>FORM A-04 PENGEMBALIAN DANA SELISIH</strong></td>
			</tr>
			<tr style="height: 19px;">
			...
			<?php endforeach; ?>
			<tr style="height: 19px;">
				<td style="width: 78.2158%; text-align: right; height: 19px; text-align: right;" colspan="4"><strong>JUMLAH</strong></td>
	...
	<table style="border-collapse: collapse; width: 100%; height: 35px; text-align: center;" border="0">
		<tbody>
			<tr style="height: 16px;">
				...
				<td style="width: 24.0164%; height: 16px;">Verifikator</td>
			</tr>
			<tr style="height: 19px;">
