	...
	<table style="border-collapse: collapse; width: 100%;" border="1">
		<tbody>
			<tr>
				...
				<td style="width: 15%; text-align: center;">Form A-03</td>
			</tr>
		</tbody>
	</table>
	<table style="border-collapse: collapse; width: 100%; height: 57px; margin-bottom: 20px;" border="0">
		<tbody>
			<tr style="height: 19px;">
				...
				<td style="width: 20.8236%; height: 19px; vertical-align: bottom;">: <?= $DataDetail->ProofSpendNo ?></td>
			</tr>
			<tr style="height: 19px;">
				<td style="width: 61.3055%; height: 38px;" colspan="2" rowspan="2">&nbsp;</td>
				<td style="width: 13.9366%; height: 19px;">TANGGAL</td>
				<td style="width: 20.8236%; height: 19px;">: <?= $DataDetail->ProofSpendDate ?></td>
			</tr>
			<tr style="height: 19px;">
				<td style="width: 13.9366%; height: 19px;">PROJECT</td>
	...
	<table style="border-collapse: collapse; width: 100%; height: 70px; margin-bottom: 10px;" border="1">
		<tbody>
			...
			<tr style="height: 19px;">
				...
				<td style="height: 19px;"><strong>Keperluan</strong></td>
				<td style="width: 20%; height: 19px; text-align: right;"><strong>Jumlah</strong></td>
			</tr>
			<?php $no = 1; ?>
			<?php foreach($DataRequests as $DataRequest) : ?>
			<tr style="height: 19px;">
				<td style="height: 19px;"><?= $no++ ?></td>
				<td style="height: 19px;"><?= $DataRequest->Spesification ?></td>
				<td style="height: 19px; text-align: right;"><?= number_format($DataRequest->Amount, 2) ?></td>
			</tr>
			<?php endforeach; ?>
			<tr style="height: 19px;">
				<td style="text-align: right; height: 19px;" colspan="2"><strong>JUMLAH</strong></td>
				<td style="height: 19px; text-align: right;"><?= number_format($DataDetail->TotalAmount, 2) ?></td>
			</tr>
		</tbody>
	</table>
	...
	<table style="border-collapse: collapse; width: 100%; height: 35px; text-align: center;" border="0">
		<tbody>
			<tr style="height: 16px;">
				...
				<td style="width: 24.0164%; height: 16px;">Verifikator Keuangan</td>
			...
			<tr style="height: 19px;">
				...
				<td style="width: 24.0164%; height: 19px;">
					<img src="<?= $DataDetail->Approval3Ttd ?>" width="24%"> 
					<br> <?= $DataDetail->Approval3Name ?>
				</td>
				<td style="width: 24.0164%; height: 19px;">
