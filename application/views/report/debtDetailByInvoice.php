...
<table width="100%">
	...
	<tr>
		<td	align="center"><b>VENDOR : <?=$DataInvoice[0]->VendorName?></b></td>
	</tr>
	<tr>
		<td	align="center">&nbsp;</td>
	</tr>
	<tr>
		<td>
			<table border="1" width="100%" id="tbl-list">
				...
				<tr>
					<td height="40px" style="padding-left: 10px">TOTAL TAGIHAN</td>
				...
				<tr class="noBorder">
					<td height="40px" colspan="2" style="padding-left: 10px">JUMLAH INVOICE</td>
