...
<style type="text/css">
    ...
    #kotak td:nth-child(6),
    #kotak td:nth-child(7),
    #kotak td:nth-child(8),
    #kotak td:nth-child(9)
    {
        text-align : center;
    }
</style>
...
<div id='page-content-wrapper'>
  ...
  <div class='container-fluid'>
    <div class='row panel'>
      <div class='col-lg-12'>
        <?=anchor(site_url('SppBtl/create/'),' <i class="glyphicon glyphicon-plus"></i> Tambah','class="btn btn-pocn"');?>
        <!-- <?=anchor(site_url('SppBtl/excel'), ' <i class="glyphicon glyphicon-th"></i> Ekspor', 'class="btn btn-one"'); ?> -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-dialog modal-lg">
      <div class="modal-header">
        ...
        <h4 class="modal-title">SPP BTL</h4>
      </div>
