...
<div id='page-content-wrapper'>
  <div class="row">
    <div class="col-md-12">
        <!--breadcrumbs start -->
        <ul class="breadcrumb">
            <li class="active">Pengeluaran Kas (A-03)</li>
        </ul>
        <!--breadcrumbs end -->
    </div>
  </div>
  ...
  <div class='container-fluid'>
    <div class='row panel'>
      <div class='col-lg-12'>
        <?=anchor(site_url('ProofSpend/create/'),' <i class="glyphicon glyphicon-plus"></i> Tambah','class="btn btn-pocn"');?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-dialog modal-lg">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Print Pengeluaran Kas (A-03)</h4>
      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      var tablelist = $('#kotak').DataTable({
          ...
          "ajax": {
              "url": base_url+'ProofSpend/ListData',
              "type": "POST",
              error: function(){
                  $(".my-grid-error").html("");
