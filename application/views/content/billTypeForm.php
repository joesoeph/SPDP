  ...
  <div class='row'>
    <div class='col-xs-12'>
      <div class="pane pane-purple">
        <div class="panel-heading"><b>Tipe Tagihan</b></div>
            ...
            <div class='box box-primary'>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class='form-group'>
                    <label class="col-md-4 control-label">Kode Tipe Tagihan</label>
                    <div class="col-md-8">
                      <input type="text" class="form-control" name="BillTypeCode" id="BillTypeCode" placeholder="Kode Tipe Tagihan" value="<?php echo $ArrData['BillTypeCode']; ?>" />
                      <?php echo form_error('BillTypeCode') ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class='form-group'>
                    <label class="col-md-4 control-label"> Nama Tipe Tagihan</label>
                    <div class="col-md-8">
                      <input type="text" class="form-control" name="BillTypeName" id="BillTypeName" placeholder="Nama Tipe Tagihan" value="<?php echo $ArrData['BillTypeName']; ?>" />
                      <?php echo form_error('BillTypeName') ?>
                    </div>
                  </div>
                </div>
              ...
              <br><br><br>
                <div class="form-action pull-right">
                  <a href="<?php echo site_url('BillType') ?>" class="btn btn-cl">Batal</a>
                  <?php
                  if($ArrData['button']){
