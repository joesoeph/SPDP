...
<div id='page-content-wrapper'>
  <div class="row">
    <div class="col-md-12">
        <!--breadcrumbs start -->
        <ul class="breadcrumb">
            <li class="active">Pengembalian Dana (A-04)</li>
        </ul>
        <!--breadcrumbs end -->
    </div>
  </div>
    ...
    <div class='row'>
      <div class="pane pane-purple">
        <div class="panel-heading">
          <b>Form Pengembalian Dana (A-04)</b>
        </div>
        <div class="panel-body">
            ...
            <div class='box box-primary'>
              ...
              <form action='<?php echo $ArrData['action']; ?>' method='post' class='form-horizontal' id="_form" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class='col-md-5'>
                        <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control" name="RefundDate" id="RefundDate" placeholder="" value="<?php echo $ArrData['RefundDate']; ?>" <?=$ArrData['attribute']?>>
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                            </div>
                        </div>
                        <?php echo form_error('RefundDate') ?>
                      </div>
                    </div>

										<div class='form-group'>
											<label class="col-md-4 control-label">Dari BPK&nbsp;:</label>
											<div class='col-md-8'>
												<select class="selectpicker" name="ProofSpendId" id="ProofSpendId" title="- Pilih -" data-show-subtext="true" data-live-search="true" data-width="100%" <?=$ArrData['attribute']?>>
													<?php
														foreach ($DataProofSpend as $val) {
															echo '<option value="'.$val->ProofSpendId.'" data-tokens="'.$val->ProofSpendNo.'" '.$val->selected.'>'.$val->ProofSpendNo.'</option>';
														}
														?>
												</select>
												<?php echo form_error('ProofSpendId') ?>
											</div>
										</div>
                ...
                <div class="row">
								...
								<?php
									if($ArrData['RefundId'] && $ArrData['LockDate'] == NULL) {
                ...
                ?>
													...
													<div class="col-md-12">
														<div id="signature-pad-creator" class="m-signature-pad">
															...
															<div class="m-signature-pad--footer">
																...
																<div class="right">
																	<button type="button" class="button save" data-action="save-png"  onclick="saveTtdNonApproval('<?=$ArrData['RefundId']?>', 'creator')">
													...
													<div class="col-md-12">
														<div id="signature-pad-1" class="m-signature-pad">
															...
															<div class="m-signature-pad--footer">
																...
																<div class="right">
																	<button type="button" class="button save" data-action="save-png"  onclick="saveTtd('<?=$ArrData['RefundId']?>', 1)">
																		<i class="glyphicon glyphicon-floppy-disk"></i>
																		Verifikasi
																	</button>
																</div>
													...
													<div class="col-md-12">
														<div id="signature-pad-2" class="m-signature-pad">
															...
															<div class="m-signature-pad--footer">
																...
																<div class="right">
																	<button type="button" class="button save" data-action="save-png" onclick="saveTtd('<?=$ArrData['RefundId']?>', 2)">
																		<i class="glyphicon glyphicon-floppy-disk"></i>
																		Verifikasi
																	</button>
																</div>
								...
								<div class="col-md-6" style="display: <?=$approval3TtdDisplay?>;">
									<div class="pane" style="background-color:#F6F6F6;">
													...
													<div class="col-md-12">
														<div id="signature-pad-3" class="m-signature-pad">
															...
															<div class="m-signature-pad--footer">
																...
																<div class="right">
																	<button type="button" class="button save" data-action="save-png" onclick="saveTtd('<?=$ArrData['RefundId']?>', 3)">
																		<i class="glyphicon glyphicon-floppy-disk"></i>
																		Verifikasi
																	</button>
																</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class='form-group'>
															<label class="col-md-3 control-label">Catatan :</label>
															<div class='col-md-9'>
																<textarea class="form-control" name="Approval3Note" id="Approval3Note" disabled><?=$ArrData['Approval3Note']?></textarea>
															</div>
														</div>
													</div>
												</div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="MessageApproval"></div>
                      <?php
                        if(($ArrData['Approval1Status'] && $ArrData['Approval2Status'] && $ArrData['Approval3Status']) && ($ArrData['Approval1Status'] != 3 && $ArrData['Approval2Status'] != 3 && $ArrData['Approval3Status'] != 3)){
                          echo '<a href="#" id="print" class="btn btn-cl pull-right" onclick="javascript:modalPrint(\''.$ArrData['RefundId'].'\');">
                      ...
                      ?>
                      <a href='<?php echo site_url('Refund') ?>' class='btn btn-one pull-right'>Kembali</a>
                    </div>
                  </div>
                </div>
          ...
          <?php
          if ($ArrData['RefundId'] && $ArrData['LockDate'] == NULL) {
            if($ArrData['Approval1Status'] == 3 || $ArrData['Approval2Status'] == 3 || $ArrData['Approval3Status'] == 3){
              echo '
              <div class="row">
                <div class="col-md-12">
                  ...
                  <br> 
                  Catatan Approver 3 : '.$ArrData['Approval3Note'].' 
                </div>
              </div>
              ';
            }
          ...
          if($ArrData['RefundId'] && $ArrData['LockDate'] == NULL) {
						...
						<div class="panel-heading text-center">
							<button type="button" class="btn btn-default" id="submitData" onclick="submitData(\''.$ArrData['RefundId'].'\')">Submit</button>
						</div>';
          }
          ?>
        </div>
...
<script type="text/javascript">
  ...
  function saveTtdNonApproval(Id, type){
      var url = base_url + 'Refund/TtdNonApproval';
      $.confirm({
