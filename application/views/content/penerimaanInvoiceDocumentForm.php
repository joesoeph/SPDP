<?php 
    $IdForm = $ArrData['PenerimaanInvoiceId']; 
    $isJabatanId = $this->session->userdata('jabatanid');
    $isVerif = 0;    
    if($DataIsVerifStatus){ if($DataIsVerifStatus[0]->JabatanId == $isJabatanId) $isVerif = 1;}
?>
<!-- Main content -->
<div id='page-content-wrapper'>
            ...
            <form action='<?php echo $ArrData['action']; ?>' method='post' class='form-horizontal'>
              <div class="col-md-6">
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <select class="selectpicker" name="ProyekId" id="ProyekId" title="- Pilih -" data-show-subtext="true" data-width="100%" <?=$ArrData['attribute']?>>
                      <?php
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <select class="selectpicker" name="VendorId" id="VendorId" title="- Pilih -" data-live-search="true" data-width="100%" <?=$ArrData['attribute']?>>
                      <?php
                        foreach ($DataVendor as $val) {
                          echo '<option value="'.$val->VendorId.'" data-tokens="'.$val->VendorName.'" '.$val->selected.'>'.$val->VendorCode.' - '.$val->VendorName.'</option>';
                        }
                       ?>
                    </select>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="InvoiceNo" id="InvoiceNo" placeholder="No. Invoice" value="<?php echo $ArrData['InvoiceNo']; ?>" <?=$ArrData['attribute']?> />
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-5'>
                    <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                        <input type="text" class="form-control" name="InvoiceDate" id="InvoiceDate" placeholder="Tgl. Invoice" value="<?php echo $ArrData['InvoiceDate']; ?>" <?=$ArrData['attribute']?>>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="FakturNo" id="FakturNo" placeholder="No. Faktur" value="<?php echo $ArrData['FakturNo']; ?>" <?=$ArrData['attribute']?>/>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="NpwpNo" id="NpwpNo" placeholder="NPWP" value="<?php echo $ArrData['NpwpNo']; ?>" <?=$ArrData['attribute']?>/>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <select class="selectpicker" name="PaymentTypeId" id="PaymentTypeId" data-show-subtext="true" title="- Pilih -" data-live-search="true" data-width="200px" <?=$ArrData['attribute']?>>
                      <?php
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="AccountNumber" id="AccountNumber" placeholder="No. Rekening" value="<?php echo $ArrData['AccountNumber']; ?>" <?=$ArrData['attribute']?>/>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="AccountByName" id="AccountByName" placeholder="No. Rekening" value="<?php echo $ArrData['AccountByName']; ?>" <?=$ArrData['attribute']?>/>
              ...
              <div class="col-md-6">
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-6'>
                    <select class="selectpicker" name="BillTypeId" id="BillTypeId" title="- Pilih -" data-width="100%" <?=$ArrData['attribute']?>>
                      <?php
                ...
                <div class='form-group'>
                      ...
                      <div class='col-md-7'>
                          <input type="text" class="form-control text-left" name="KontrakNo" id="KontrakNo" placeholder="" value="<?php echo $ArrData['KontrakNo']; ?>" <?=$ArrData['attribute']?>/>
                    ...
                    <div class='form-group'>
                      ...
                      <div class='col-md-4'>
                        <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control" name="KontrakDate" id="KontrakDate" placeholder="" value="<?php echo $ArrData['KontrakDate']; ?>" <?=$ArrData['attribute']?>>
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                            </div>
                        </div>
                    ...
                    <div class='col-md-7'>
                      <textarea class="form-control Description" rows="5" name="KontrakDescription" id="KontrakDescription" <?=$ArrData['attribute']?>><?php echo $ArrData['KontrakDescription']; ?></textarea>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-5'>
                    <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                        <input type="text" class="form-control" name="ReceivedDate" id="ReceivedDate" placeholder="Tgl. Terima" value="<?php echo $ArrData['ReceivedDate']; ?>" <?=$ArrData['attribute']?>>
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-th"></span>
                        </div>
                    </div>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <select class="selectpicker" name="SenderId" id="SenderId" title="- Pilih -" data-show-subtext="true" data-live-search="true" data-width="150px" <?=$ArrData['attribute']?>>
                      <?php
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="OtherSenderName" id="OtherSenderName" placeholder="Other Sender Name" value="<?php echo $ArrData['OtherSenderName']; ?>" <?=$ArrData['attribute']?>/>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-md-8'>
                    <input type="text" class="form-control" name="OtherSenderTelp" id="OtherSenderTelp" placeholder="Other Sender Telp" value="<?php echo $ArrData['OtherSenderTelp']; ?>" <?=$ArrData['attribute']?>/>
                    ...
                    <div class='box box-primary'>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-md-8'>
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="RealCost" id="RealCost" placeholder="Real Cost" value="<?php echo $ArrData['RealCost']; ?>" <?=$ArrData['attribute']?>/>
                            </div>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-md-8'>
                            <div class="input-group">
                              <select class="selectpicker" name="PpnId" id="PpnId" title="- Pilih -" <?=$ArrData['attribute']?>>
                                <?php
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-md-8'>
                            <div class="input-group">
                              <select class="selectpicker" name="PphId" id="PphId" title="- Pilih -" <?=$ArrData['attribute']?>>
                                <?php
              ...
              <div class='form-action'>
                  <?php 
                    if($ArrData['button'] && $ArrData['LockDate'] == NULL){
                        ...
                        {
                             if($ArrData['button']) echo '<button type="submit" class="btn btn-ok pull-right">'.$ArrData['button'].'</button>';
                        }
                    } 
                  ?>
  ...
  <!-- </div> -->
        ...
        <div class="row">
          <div class="col-md-12">
              <div class="pane pane-purple">
                ...
                <?php
                  if($ArrData['PenerimaanInvoiceId'] && $ArrData['LockDate'] == NULL){
                      if($this->session->userdata('role') != 9)
                      {
                       echo '
                        <div class="panel-heading text-center">
                          <button type="button" class="btn btn-default" id="submitData" onclick="submitData(\''.$ArrData['PenerimaanInvoiceId'].'\')">Submit</button>
                        </div>';
                      }
                  }
                 ?>
        ...
        if($DataIsVerifStatus){
            if ($isVerif == 1){
                if($ArrData['PenerimaanInvoiceId'] != NULL && $ArrData['LockDate'] != NULL){
        ?>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class='form-group'>
                                ...
                                <div class='col-md-4'>
                                  <select class="selectpicker" name="InvoiceVerificationStatus" id="InvoiceVerificationStatus" data-show-subtext="false" data-live-search="false" data-width="100%" onchange="$('#ClearTtd').click();">
                              ...
                              <div class="col-md-12">
                                <div id="signature-pad" class="m-signature-pad">
                                  <div class="m-signature-pad--body">
                                    <input type="hidden" id="ttdValue" value="<?=$DataCompleteVerification->Ttd?>">
                                    <img src="<?=$DataCompleteVerification->Ttd?>" width="100%" id="ttdImage">
                                    <canvas></canvas>
                                  </div>
                                  <div class="m-signature-pad--footer">
                                    ...
                                    <div class="left">
                                      <button type="button" class="button clear" data-action="clear" id="ClearTtd">
                                        <i class="glyphicon glyphicon-trash"></i>
                                        Kosongkan TTD
                                      </button>
                                    </div>
                                    <div class="right">
                                      <button type="button" class="button save" data-action="save-png"  onclick="saveTtd('<?=$ArrData['PenerimaanInvoiceId']?>', '<?=$this->session->userdata('jabatanid')?>')">
              ...
              <div class="portlet-body form">
                ...
                <div id="divLooks<?=$SubVal->BillTypeId.$SubVal->DocumentId;?>" class="form-horizontal col-md-8">
                  <form method="post" action="<?=base_url("PenerimaanInvoice/UploadDocument/s".$SubVal->BillTypeId.$SubVal->DocumentId."/".$IdForm);?>" id="Uploads<?=$SubVal->BillTypeId.$SubVal->DocumentId;?>" name="Uploads<?=$SubVal->BillTypeId.$SubVal->DocumentId;?>">
                    ...
                    <?php 
                      if($ArrData['button'] && $ArrData['LockDate'] == NULL){
                          if($this->session->userdata('role') != 9 || $this->session->userdata('role') != 12)
                          {?>
...
<script type="text/javascript">
  ...
  function viewDocument(PenerimaanInvoiceId, DocumentId, Path){
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#modal-print-verification #frame-pdf-verification').attr("src", base_url + "/upload/" + Path + "?timestamp=1357571065");
  ...
  function saveTtd(PenerimaanInvoiceId, JabatanId){
    $.confirm({
          ...
          'confirm': {
              ...
              action: function () {
                ...
                if (!pngFile) {
                  ...
                  var Status = $('#InvoiceVerificationStatus').val();
                  var Note   = $('#InvoiceVerificationNote').val();
                  $.ajax({
                    url: base_url+'PenerimaanInvoice/Ttd',
                    type: 'POST',
                    dataType: 'html',
                    data: {
                      PenerimaanInvoiceId: PenerimaanInvoiceId,
  ...
  function submitData(PenerimaanInvoiceId){
    $.confirm({
        ...
        buttons: {
          'confirm': {
              ...
              action: function () {
                $.ajax({
                  url: base_url+'PenerimaanInvoice/LockPenerimaanInvoice',
                  type: 'POST',
                  dataType: 'html',
                  data: {
                    PenerimaanInvoiceId: PenerimaanInvoiceId
