...
<div id='page-content-wrapper'>
  ...
  <div class='container-fluid'>
    <div class='row panel'>
      <div class='col-lg-12'>
        <?=anchor(site_url('BudgetRequest/create/'),' <i class="glyphicon glyphicon-plus"></i> Tambah','class="btn btn-pocn"');?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-dialog modal-lg">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Print Pengajuan Dana (A-02)</h4>
      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      var tablelist = $('#kotak').DataTable({
          ...
          "ajax": {
              "url": base_url+'BudgetRequest/ListData',
              "type": "POST",
              error: function(){
                  $(".my-grid-error").html("");
