...
<div id='page-content-wrapper'>
  ...
  <div class='container-fluid'>
    <div class='row panel'>
      <div class='col-lg-12'>
		  <?php echo anchor(site_url('agreement/create/'),' <i class="glyphicon glyphicon-plus"></i> Tambah','class="btn btn-pocn"');?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-dialog modal-lg">
      <div class="modal-header">
        ...
        <h4 class="modal-title">SPB & SPJB</h4>
      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
        ...
        var tablelist = $('#kotak').DataTable({
            ...
            "ajax": {
                "url": base_url+'Agreement/ListData',
                "type": "POST",
                error: function(){
                    $(".my-grid-error").html("");
