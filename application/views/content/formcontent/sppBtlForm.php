          ...
          <div class='col-xs-12'>
            <div class='box box-primary'>
              ...
              <form action='<?php echo $ArrData['action']; ?>' method='post' class='form-horizontal'>
                                ...
                                for ($i=1; $i <= 15; $i++) {
                                  echo "
                                    <tr>
                                      ...
                                      <td>
                                        <input type='text' name='Quantity".$i."' id='Quantity".$i."' class='form-control input-sm' value='".($i <= $CountData ? $Quantity[$i] : "")."' ".$ArrData['attribute'].">
                                      </td>
                                      <td>
                ...
                <?php 
                if ($ArrData['SppBtlId'] && $ArrData['LockDate'] != NULL) {
                          ...
                          <div class="col-md-12">
                            <div id="signature-pad" class="m-signature-pad">
                              ...
                              <div class="m-signature-pad--footer">
                                ...
                                <div class="right">
                                  <button type="button" class="button save" data-action="save-png"  onclick="saveTtd('<?=$ArrData['SppBtlId']?>', 3)">
                          ...
                          <div class="col-md-12">
                            <div id="signature-pad" class="m-signature-pad">
                              ...
                              <div class="m-signature-pad--footer">
                                ...
                                <div class="right">
                                  <button type="button" class="button save" data-action="save-png"  onclick="saveTtd('<?=$ArrData['SppBtlId']?>', 1)">
                                    <i class="glyphicon glyphicon-floppy-disk"></i>
                                    Verifikasi
                                  </button>
                                </div>
                          ...
                          <div class="col-md-12">
                            <div id="signature-pad" class="m-signature-pad">
                              ...
                              <div class="m-signature-pad--footer">
                                ...
                                <div class="right">
                                  <button type="button" class="button save" data-action="save-png" onclick="saveTtd('<?=$ArrData['SppBtlId']?>', 2)">
                                    <i class="glyphicon glyphicon-floppy-disk"></i>
                                    Verifikasi
                                  </button>
                                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="MessageApproval"></div>
                      <?php
                        if(($ArrData['Approval1Status'] && $ArrData['Approval2Status']) && ($ArrData['Approval1Status'] != 3 && $ArrData['Approval2Status'] != 3)){
                          echo '<a href="#" id="print" class="btn btn-cl pull-right" onclick="javascript:modalPrint(\''.$ArrData['SppBtlId'].'\');">
                      ...
                      ?>
                      <a href='<?php echo site_url('SppBtl') ?>' class='btn btn-pocn pull-right'>Kembali</a>
                    </div>
                  </div>
                </div>
          ...
          if($ArrData['SppBtlId'] && $ArrData['LockDate'] == NULL){
              if($this->session->userdata('role') != 9)
              {
                ...
                <div class="panel-heading text-center">
                  <button type="button" class="btn btn-default" id="submitData" onclick="submitData(\''.$ArrData['SppBtlId'].'\')">Submit</button>
                </div>';
              }
          }
          ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-dialog modal-lg">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Print SPP BTL</h4>
      </div>
...
<script type="text/javascript">
  function modalPrint(id){
    ...
    $('#modal-print #frame-pdf').attr("src", "<?=base_url('SppBtl/Report/')?>"+id);
  }

  function saveTtd(SppBtlId, Approval){
    var url = (Approval != 3 ? base_url+'SppBtl/Ttd' : base_url+'SppBtl/TtdVerifycator');
    $.confirm({
    ...
    $.confirm({
        ...
        buttons: {
          'confirm': {
              ...
              action: function () {
                $.ajax({
                  url: base_url+'SppBtl/LockSppBtl',
                  type: 'POST',
                  dataType: 'html',
                  data: {
                    SppBtlId: SppBtlId
