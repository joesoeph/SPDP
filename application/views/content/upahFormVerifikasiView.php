  ...
  <div class="container-fluid">
    <div class='row'>
      <div class='col-xs-12'>
            ...
            <div class='box'>
              ...
              <div class="form-horizontal">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">DUB</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">BAU</label>
                  <div class="col-sm-6">
                    <span class="btn btn-pocn btn-file">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">KONTRAK (SPK)</label>
                  <div class="col-sm-6">
                    <span class="btn btn-pocn btn-file">
        ...
        <script src="<?=base_url('public/master/UPAHVerifikasiInvoice.js')?>"></script>
